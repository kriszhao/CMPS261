...
function clickOnTheBoxes(elementToSelect, drawToDom){
    $(elementToSelect).attr('data','body-boxes.svg?'+new Date().getTime())
...
function createLink(bodyPart, className){
    ...
    $('table').append($('<tr class="wiki-style" ><td colspan="2"><a href="file:///Users/zekunzhao/venv/Git/heatmap.js-2.0.5/examples/svg-area-heatmap/dataset-layout.html' +'"rel="noopener noreferrer">Analysis</a></td></tr>'));
}
